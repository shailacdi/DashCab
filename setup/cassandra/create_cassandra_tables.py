...
session.execute("CREATE TABLE if not exists medallion_driver_assignment (assign_date text, hack_license text, medallion_id text, lat float, long float, PRIMARY KEY (assign_date, driver_id))")
